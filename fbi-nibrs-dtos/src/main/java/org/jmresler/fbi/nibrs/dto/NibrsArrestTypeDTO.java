 ...
 */
@Data
public class NibrsArrestTypeDTO implements Serializable {
    ...
    public String toString() {
        return  "org.jmresler.fbi.nibrs.dto.NibrsArrestTypeDTO[" + arrestTypeId + ", " + arrestTypeCode + ", " + arrestTypeCode + "]";
    }
