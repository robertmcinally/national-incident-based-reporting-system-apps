 ...
 */
@Data
public class NibrsAssignmentTypeDTO implements Serializable {
    ...
    public String toString() {
        return  "org.jmresler.fbi.nibrs.dto.NibrsAssignmentTypeDTO[" + assignmentTypeId + ", " + assignmentTypeCode + ", " + assignmentTypeCode + "]";
    }
