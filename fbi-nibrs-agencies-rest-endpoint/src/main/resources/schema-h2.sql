...
alter table NIBRS_SUSPECTED_DRUG
    add constraint NIBRS_SUSPECTED_DRUG_PK primary key (NIBRS_SUSPECTED_DRUG_ID);

alter table NIBRS_RELATIONSHIP
    add constraint NIBRS_RELATIONSHIP_PK primary key (RELATIONSHIP_ID);

alter table NIBRS_DRUG_MEASURE_TYPE
    add constraint NIBRS_DRUG_MEASURE_TYPE_PK primary key (DRUG_MEASURE_TYPE_ID);

alter table NIBRS_USING_LIST
    add constraint NIBRS_SUSPECTED_USING_PK primary key (SUSPECT_USING_ID);

alter table NIBRS_PROP_LOSS_TYPE
    add constraint NIBRS_PROP_LOSS_TYPE_PK primary key (PROP_LOSS_ID);

alter table NIBRS_ETHNICITY
    add constraint NIBRS_ETH_PK primary key (ETHNICITY_ID);

alter table NIBRS_PROPERTY
    add constraint NIBRS_PROPERTY_PK primary key (PROPERTY_ID);

alter table NIBRS_CRIMINAL_ACT
    add constraint NIBRS_CRIMINAL_ACT_PK primary key (CRIMINAL_ACT_ID,
                                                      OFFENSE_ID);

alter table NIBRS_OFFENSE_TYPE
    add constraint NIBRS_OFFENSE_TYPE_PK primary key (offense_code);

alter table NIBRS_CRIMINAL_ACT_TYPE
    add constraint NIBRS_CRIMINAL_ACT_TYPE_PK primary key (CRIMINAL_ACT_ID);

alter table NIBRS_PROPERTY_DESC
    add constraint NIBRS_PROPERTY_DESC_PK primary key (property_id,
                                                       prop_desc_id);

alter table NIBRS_INCIDENT
    add constraint NIBRS_INCIDENT_PK primary key (INCIDENT_ID);

alter table NIBRS_BIAS_MOTIVATION
    add constraint NIBRS_BIAS_MOTIVATION_PK primary key (BIAS_ID,
                                                         OFFENSE_ID);

alter table NIBRS_SUSPECT_USING
    add constraint NIBRS_SUSPECT_USING_PK primary key (SUSPECT_USING_ID,
                                                       OFFENSE_ID);

alter table NIBRS_VICTIM_TYPE
    add constraint NIBRS_VICTIM_TYPE_PK primary key (VICTIM_TYPE_ID);

alter table NIBRS_INJURY
    add constraint NIBRS_INJURY_PK primary key (INJURY_ID);

alter table NIBRS_OFFENDER
    add constraint NIBRS_OFFENDER_PK primary key (OFFENDER_ID);

alter table NIBRS_CIRCUMSTANCES
    add constraint NIBRS_CIRCUMSTANCES_PK primary key (CIRCUMSTANCES_ID);

alter table NIBRS_ACTIVITY_TYPE
    add constraint NIBRS_ACTIVITY_TYPE_PK primary key (ACTIVITY_TYPE_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_PK primary key (ARRESTEE_ID);

alter table NIBRS_WEAPON_TYPE
    add constraint NIBRS_WEAPON_TYPE_PK primary key (WEAPON_ID);

alter table NIBRS_BIAS_LIST
    add constraint NIBRS_BIAS_LIST_PK primary key (BIAS_ID);

alter table NIBRS_ARREST_TYPE
    add constraint NIBRS_ARREST_TYPE_PK primary key (ARREST_TYPE_ID);

alter table NIBRS_VICTIM_INJURY
    add constraint NIBRS_VICTIM_INJURY_PK primary key (VICTIM_ID,
                                                       INJURY_ID);

alter table NIBRS_OFFENSE
    add constraint NIBRS_OFFENSE_PK primary key (OFFENSE_ID);

alter table NIBRS_VICTIM_OFFENDER_REL
    add constraint NIBRS_VICTIM_OFFENDER_REL_PK primary key (victim_id,
                                                             offender_id);

alter table NIBRS_CLEARED_EXCEPT
    add constraint NIBRS_CLEARED_EXCEPT_PK primary key (CLEARED_EXCEPT_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_PK primary key (VICTIM_ID);

alter table NIBRS_MONTH
    add constraint NIBRS_MONTH_PK primary key (did);

alter table NIBRS_AGE
    add constraint NIBRS_AGE_PK primary key (AGE_ID);

alter table NIBRS_PROP_DESC_TYPE
    add constraint NIBRS_PROP_DESC_TYPE_PK primary key (PROP_DESC_ID);

alter table NIBRS_VICTIM_CIRCUMSTANCES
    add constraint NIBRS_VICTIM_CIRCUMSTANCES_PK primary key (VICTIM_ID,
                                                              CIRCUMSTANCES_ID);

alter table NIBRS_ARRESTEE_WEAPON
    add constraint NIBRS_ARRESTEE_WEAPON_PK primary key (arrestee_id,
                                                         weapon_id);

alter table NIBRS_SUSPECTED_DRUG_TYPE
    add constraint NIBRS_SUSPECTED_DRUG_TYPE_PK primary key (SUSPECTED_DRUG_TYPE_ID);

alter table NIBRS_VICTIM_OFFENSE
    add constraint NIBRS_VICTIM_OFFENSE_PK primary key (VICTIM_ID,
                                                        OFFENSE_ID);

alter table NIBRS_LOCATION_TYPE
    add constraint NIBRS_LOCATION_TYPE_PK primary key (LOCATION_ID);

alter table NIBRS_ASSIGNMENT_TYPE
    add constraint NIBRS_ASSIGN_TYPE_PK primary key (ASSIGNMENT_TYPE_ID);

alter table NIBRS_WEAPON
    add constraint NIBRS_WEAPON_PK primary key (weapon_id,
                                                offense_id);

alter table REF_RACE
    add constraint REF_RACE_PK primary key (RACE_ID);

alter table REF_STATE
    add constraint REF_STATE_PK primary key (STATE_ID);

alter table AGENCIES
    add constraint AGENCIES_PK primary key (agency_id);

alter table NIBRS_JUSTIFIABLE_FORCE
    add constraint NIBRS_JUSTIFIABLE_FORCE_PK primary key (JUSTIFIABLE_FORCE_ID);
-- Foreign Keys

alter table NIBRS_ARRESTEE_WEAPON
    add constraint NIBRS_ARREST_WEAP_ARREST_FK foreign key (ARRESTEE_ID)
        references NIBRS_ARRESTEE (ARRESTEE_ID) on
            delete
            cascade;

alter table NIBRS_ARRESTEE_WEAPON
    add constraint NIBRS_ARREST_WEAP_TYPE_FK foreign key (WEAPON_ID)
        references NIBRS_WEAPON_TYPE (WEAPON_ID);

alter table NIBRS_PROPERTY_DESC
    add constraint NIBRS_PROP_DESC_PROP_FK foreign key (PROPERTY_ID)
        references NIBRS_PROPERTY (PROPERTY_ID) on
            delete
            cascade;

alter table NIBRS_PROPERTY_DESC
    add constraint NIBRS_PROP_DESC_TYPE_FK foreign key (PROP_DESC_ID)
        references NIBRS_PROP_DESC_TYPE (PROP_DESC_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_AGE_FK foreign key (AGE_ID)
        references NIBRS_AGE (AGE_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_ARREST_TYPE_FK foreign key (ARREST_TYPE_ID)
        references NIBRS_ARREST_TYPE (ARREST_TYPE_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_ETHNICITY_FK foreign key (ETHNICITY_ID)
        references NIBRS_ETHNICITY (ETHNICITY_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_INC_FK foreign key (INCIDENT_ID)
        references NIBRS_INCIDENT (INCIDENT_ID) on
            delete
            cascade;

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_RACE_FK foreign key (RACE_ID)
        references REF_RACE (RACE_ID);

alter table NIBRS_ARRESTEE
    add constraint NIBRS_ARRESTEE_OFFENSE_TYPE_FK foreign key (offense_code)
        references NIBRS_OFFENSE_TYPE (offense_code);

alter table NIBRS_SUSPECTED_DRUG
    add constraint NIBRS_SUSP_DRUG_MEAS_TYPE_FK foreign key (DRUG_MEASURE_TYPE_ID)
        references NIBRS_DRUG_MEASURE_TYPE (DRUG_MEASURE_TYPE_ID);

alter table NIBRS_SUSPECTED_DRUG
    add constraint NIBRS_SUSP_DRUG_PROP_FK foreign key (PROPERTY_ID)
        references NIBRS_PROPERTY (PROPERTY_ID) on
            delete
            cascade;

alter table NIBRS_SUSPECTED_DRUG
    add constraint NIBRS_SUSP_DRUG_TYPE_FK foreign key (SUSPECTED_DRUG_TYPE_ID)
        references NIBRS_SUSPECTED_DRUG_TYPE (SUSPECTED_DRUG_TYPE_ID);

alter table NIBRS_PROPERTY
    add constraint NIBRS_PROPERTY_INC_FK foreign key (INCIDENT_ID)
        references NIBRS_INCIDENT (INCIDENT_ID) on
            delete
            cascade;

alter table NIBRS_PROPERTY
    add constraint NIBRS_PROPERTY_LOSS_TYPE_FK foreign key (PROP_LOSS_ID)
        references NIBRS_PROP_LOSS_TYPE (PROP_LOSS_ID);

alter table NIBRS_CRIMINAL_ACT
    add constraint NIBRS_CRIMINAL_ACT_OFFENSE_FK foreign key (OFFENSE_ID)
        references NIBRS_OFFENSE (OFFENSE_ID) on
            delete
            cascade;

alter table NIBRS_CRIMINAL_ACT
    add constraint NIBRS_CRIMINAL_ACT_TYPE_FK foreign key (CRIMINAL_ACT_ID)
        references NIBRS_CRIMINAL_ACT_TYPE (CRIMINAL_ACT_ID);

alter table NIBRS_OFFENDER
    add constraint NIBRS_OFFENDER_AGE_FK foreign key (AGE_ID)
        references NIBRS_AGE (AGE_ID);

alter table NIBRS_OFFENDER
    add constraint NIBRS_OFFENDER_ETHNICITY_FK foreign key (ETHNICITY_ID)
        references NIBRS_ETHNICITY (ETHNICITY_ID);

alter table NIBRS_OFFENDER
    add constraint NIBRS_OFFENDER_NIBRS_INCI_FK1 foreign key (INCIDENT_ID)
        references NIBRS_INCIDENT (INCIDENT_ID) on
            delete
            cascade;

alter table NIBRS_OFFENDER
    add constraint NIBRS_OFFENDER_RACE_FK foreign key (RACE_ID)
        references REF_RACE (RACE_ID);

alter table NIBRS_VICTIM_INJURY
    add constraint NIBRS_VIC_INJURY_NIBRS_INJ_FK foreign key (INJURY_ID)
        references NIBRS_INJURY (INJURY_ID);

alter table NIBRS_VICTIM_INJURY
    add constraint NIBRS_VIC_INJURY_NIBRS_VIC_FK foreign key (VICTIM_ID)
        references NIBRS_VICTIM (VICTIM_ID) on
            delete
            cascade;

alter table NIBRS_WEAPON
    add constraint NIBRS_WEAP_WEAP_TYPE_FK foreign key (WEAPON_ID)
        references NIBRS_WEAPON_TYPE (WEAPON_ID);

alter table NIBRS_WEAPON
    add constraint NIBRS_WEAP_OFF_FK foreign key (OFFENSE_ID)
        references NIBRS_OFFENSE (OFFENSE_ID) on
            delete
            cascade;

alter table NIBRS_VICTIM_CIRCUMSTANCES
    add constraint NIBRS_VIC_CIRC_NIBRS_VIC_FK foreign key (VICTIM_ID)
        references NIBRS_VICTIM (VICTIM_ID) on
            delete
            cascade;

alter table NIBRS_VICTIM_CIRCUMSTANCES
    add constraint NIBRS_VICTIM_CIRC_JUST_HOM_FK foreign key (JUSTIFIABLE_FORCE_ID)
        references NIBRS_JUSTIFIABLE_FORCE (JUSTIFIABLE_FORCE_ID);

alter table NIBRS_VICTIM_CIRCUMSTANCES
    add constraint NIBRS_VIC_CIRC_NIBRS_CIRC_FK foreign key (CIRCUMSTANCES_ID)
        references NIBRS_CIRCUMSTANCES (CIRCUMSTANCES_ID);

alter table NIBRS_SUSPECT_USING
    add constraint NIBRS_SUSPECT_USING_OFF_FK foreign key (OFFENSE_ID)
        references NIBRS_OFFENSE (OFFENSE_ID) on
            delete
            cascade;

alter table NIBRS_SUSPECT_USING
    add constraint NIBRS_SUSPECT_USING_LIST_FK foreign key (SUSPECT_USING_ID)
        references NIBRS_USING_LIST (SUSPECT_USING_ID);

alter table NIBRS_OFFENSE
    add constraint NIBRS_OFFENSE_INC_FK1 foreign key (INCIDENT_ID)
        references NIBRS_INCIDENT (INCIDENT_ID) on
            delete
            cascade;

alter table NIBRS_OFFENSE
    add constraint NIBRS_OFFENSE_LOC_TYPE_FK foreign key (LOCATION_ID)
        references NIBRS_LOCATION_TYPE (LOCATION_ID);

alter table NIBRS_OFFENSE
    add constraint NIBRS_OFFENSE_OFF_TYPE_FK foreign key (offense_code)
        references NIBRS_OFFENSE_TYPE (offense_code);

alter table NIBRS_VICTIM_OFFENDER_REL
    add constraint NIBRS_VICTIM_OFF_REL_VIC_FK foreign key (VICTIM_ID)
        references NIBRS_VICTIM (VICTIM_ID) on
            delete
            cascade;

alter table NIBRS_VICTIM_OFFENDER_REL
    add constraint NIBRS_VICTIM_OFF_REL_OFF_FK foreign key (OFFENDER_ID)
        references NIBRS_OFFENDER (OFFENDER_ID) on
            delete
            cascade;

alter table NIBRS_VICTIM_OFFENDER_REL
    add constraint NIBRS_VICTIM_OFF_REL_REL_FK foreign key (RELATIONSHIP_ID)
        references NIBRS_RELATIONSHIP (RELATIONSHIP_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIMS_VIC_TYPE_FK foreign key (VICTIM_TYPE_ID)
        references NIBRS_VICTIM_TYPE (VICTIM_TYPE_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_ACT_TYPE_FK foreign key (ACTIVITY_TYPE_ID)
        references NIBRS_ACTIVITY_TYPE (ACTIVITY_TYPE_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_AGE_FK foreign key (AGE_ID)
        references NIBRS_AGE (AGE_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_ASSIGN_TYPE_FK foreign key (ASSIGNMENT_TYPE_ID)
        references NIBRS_ASSIGNMENT_TYPE (ASSIGNMENT_TYPE_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_ETHNICITY_FK foreign key (ETHNICITY_ID)
        references NIBRS_ETHNICITY (ETHNICITY_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_RACE_FK foreign key (RACE_ID)
        references REF_RACE (RACE_ID);

alter table NIBRS_VICTIM
    add constraint NIBRS_VICTIM_INC_FK foreign key (INCIDENT_ID)
        references NIBRS_INCIDENT (INCIDENT_ID) on
            delete
            cascade;

alter table NIBRS_MONTH
    add constraint NIBRS_MONTH_AGENCY_FK foreign key (AGENCY_ID)
        references AGENCIES (AGENCY_ID);

alter table NIBRS_INCIDENT
    add constraint NIBRS_INCIDENT_AGENCY_FK foreign key (AGENCY_ID)
        references AGENCIES (AGENCY_ID);

alter table NIBRS_INCIDENT
    add constraint NIBRS_INCIDENT_CLEAR_EX_FK foreign key (CLEARED_EXCEPT_ID)
        references NIBRS_CLEARED_EXCEPT (CLEARED_EXCEPT_ID);

alter table NIBRS_INCIDENT
    add constraint NIBRS_INCIDENT_MONTH_FK foreign key (did)
        references NIBRS_MONTH (did) on
            delete
            cascade;

alter table NIBRS_VICTIM_OFFENSE
    add constraint NIBRS_VIC_OFF_NIBRS_VIC_FK foreign key (VICTIM_ID)
        references NIBRS_VICTIM (VICTIM_ID) on
            delete
            cascade;

alter table NIBRS_VICTIM_OFFENSE
    add constraint NIBRS_VIC_OFF_NIBRS_OFF_FK foreign key (OFFENSE_ID)
        references NIBRS_OFFENSE (OFFENSE_ID) on
            delete
            cascade;

alter table NIBRS_BIAS_MOTIVATION
    add constraint NIBRS_BIAS_MOT_OFFENSE_FK foreign key (OFFENSE_ID)
        references NIBRS_OFFENSE (OFFENSE_ID) on
            delete
            cascade;

alter table NIBRS_BIAS_MOTIVATION
    add constraint NIBRS_BIAS_MOT_LIST_FK foreign key (BIAS_ID)
